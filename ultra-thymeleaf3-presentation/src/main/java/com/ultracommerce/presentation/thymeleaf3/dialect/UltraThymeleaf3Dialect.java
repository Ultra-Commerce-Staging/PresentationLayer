...
public class UltraThymeleaf3Dialect extends AbstractProcessorDialect implements IExpressionObjectDialect {
    ...
    public UltraThymeleaf3Dialect() {
        super("Ultra Common Dialect", UltraDialectPrefix.UC.toString(), SpringStandardDialect.PROCESSOR_PRECEDENCE);
    }
    
    public UltraThymeleaf3Dialect(final String name, final String prefix, final int processorPrecedence) {
